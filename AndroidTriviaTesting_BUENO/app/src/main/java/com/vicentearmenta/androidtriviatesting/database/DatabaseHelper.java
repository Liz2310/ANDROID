...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String seedQuestionTable = " INSERT INTO " + TABLE_QUESTION + " (" + COLUMN_QT_ID + ", "
                ...
                "(3, 'In MonstersInc., what city do Mike and Sulley live in?',3)," +
                "(4, 'What is the name of the talking dog in Up?',4)," +
                "(5, 'In the Incredibles what is Frozones actual first name?',5)," +
                "(6, 'In Cars, Lightning McQueen finds himself stuck in what town?',6)," +
                "(7, 'In Coco, what does Miguels family make for a living?',7)," +
                "(8, 'What is the address that Marlin and Dory are trying to reach in Finding Nemo?',8)," +
                "(9, 'Who is the leader of the food stealing grasshopper in gang in A Bugs Life?',9)," +
...
// Logica para crear la base de datos